...
import com.example.sqlitebd.database.DBHelper
import com.example.sqlitebd.database.ToDoItemModel
import java.util.*
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showActionsDialog(position: Int) {
        val options = arrayOf<CharSequence>("Edit This To Do Item!", "Delete This To Do Item?", "Delete All To Do Items?")
    ...
    private fun showEntryDialog(shouldUpdate: Boolean, toDoItemModel: ToDoItemModel?, position: Int) {
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(View.OnClickListener {
            ...
            if (TextUtils.isEmpty(todoItem.text.toString())) {
                Toast.makeText(this@MainActivity, "Enter dialog_entry!", Toast.LENGTH_SHORT).show()
